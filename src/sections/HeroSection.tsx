      ...
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center w-full">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-5 max-w-md text-sm leading-relaxed text-white">
            {profile.shortBio}{" "}
            <span className="text-white/90">{profile.longBio}</span>
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="inline-flex items-center gap-2 rounded-md border border-[var(--line-border)] bg-black/40 px-3 py-2 text-sm font-medium text-white/90 transition-all hover:bg-white/5"
              >
        ...
        <div className="relative min-h-[500px] overflow-hidden rounded-xl bg-[#0a0602]">
          ...
          <div className="absolute bottom-5 left-5 right-5 flex items-center gap-3 rounded-lg border border-[var(--line-border)] bg-black/60 p-3.5 backdrop-blur-sm">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-[var(--line-border)] bg-[rgba(255,106,0,0.1)]">
            ...
            <div className="min-w-0">
              <p className="font-mono-ui text-[11px] uppercase tracking-[0.14em] text-[var(--primary-accent)]">
                Education
              </p>
